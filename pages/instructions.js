    ...
    return (
        <div>
            <div className={styles.instructionsCard}>
                ...
                <Image src='/instructions/google-takeout.png' alt="me" width={850} height={420} />
            </div>

            <div className={styles.instructionsCard}>
                <h2 className={styles.instructionsBody}>Scroll down and hit deselect all to uncheck all of the chosen data. </h2>
                <Image src='/instructions/deselect-all.png' alt="me" width={850} height={420}/>
            </div>
            ...
            <div className={styles.instructionsCard}>
                ...
                <Image src='/instructions/select-youtube.png' alt="me" width={850} height={420}/>
            </div>

            <div className={styles.instructionsCard}>
                <h2 className={styles.instructionsBody}>Under the History tab, change the format from HTML to JSON and hit OK.</h2>
                <Image src='/instructions/conversion.png' alt="me" width={850} height={420}/>
            </div> 
            ...
            <div className={styles.instructionsCard}>
                ...
                <Image src='/instructions/create-export.png' alt="me" width={850} height={420}/>
            </div>

            <div className={styles.instructionsCard}>
                <h2 className={styles.instructionsBody}>When the data is ready, go to the email from Google and download your files.</h2>
                <Image src='/instructions/download-your-files.png' alt="me" width={850} height={420}/>
            </div>
            ...
            <div className={styles.instructionsCard}>
                ...
                <Image src='/instructions/extract-all.png' alt="me" width={850} height={420}/>
            </div>
            ...
            <div className={styles.instructionsCard}>
                ...
                <Image src='/instructions/zip-file.png' alt="me" width={850} height={420}/>
            </div>
        </div>
    )
}
